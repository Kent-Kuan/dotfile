# Generated by Powerlevel10k configuration wizard on 2026-01-08 at 16:01 CST.
...
# 2 lines, dotted, light-ornaments, sparse, concise, instant_prompt=verbose.
...
# custom function
function prompt_envbadge() {
    [[ -z "$ENV_BADGE" ]] && return

    if [[ "$ENV_BADGE" == "PROD" ]]; then
        p10k segment -b "red" -f "white" -t "🔴 PROD"
    elif [[ "$ENV_BADGE" == "DEV" ]]; then
        p10k segment -b "green" -f "white" -t "✓ DEV"
    fi
}
# custom function
...
() {
  ...
  function prompt_example() {
    p10k segment -b 1 -f 3 -i '*' -t 'hello33333, %n'
  }
